      ...
      deals: [
        {
          ...
          priceBasis: "google_hotels_provider_all_inclusive_v8",
          distanceKm: null,
          distanceVerified: false,
        },
        {
          id: "google-information-heading",
          monitorId: monitor.id,
          monitorFingerprint: fingerprint,
          source: "google_hotels",
  ...
  const deals = buildDealMap(
    {
      deals: [
        ...
        },
        {
          ...
          priceBasis: "bluepillow_api_unchanged_total_v2",
        },
      ],
    },
    [comparisonMonitor],
  ...
  const deals = buildDealMap(
    {
      deals: [
        ...
        },
        {
          ...
          monitorFingerprint: currentFingerprint,
          source: "trip",
          priceBasis: "trip_direct_final_total_v2",
